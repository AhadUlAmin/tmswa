...
function contactUs(){
	...
	//var dataString = 'newpass='+ newpass + '&altname=' + altname +'&md5oldpass=' + md5oldpass  + '&page=reset_password';
		...
		$.ajax({
			type: "POST",
			url: "<?php echo BASE_PATH; ?>contact_us_app.php",
			data: dataString,
			cache: false,
			beforeSend: function() 
			{
...
<section style="width:100%;background:#e3e3f3;margin-top: -14px;    background: url('https://www.themornstar.com/en-us/assets/img/banners/100.jpg') center center no-repeat #837978;background-size: 100% 700px;">
