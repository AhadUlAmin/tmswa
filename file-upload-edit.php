...
// $_SESSION["ALT_USERNAME"] $_SESSION["USER_ID"]
/*     $user_id = $_SESSION["USER_ID"];
	$alt_username = $_SESSION["ALT_USERNAME"] ;
	
	$count_query = mysql_query("SELECT * FROM `article` WHERE `article_writer` ='$alt_username'");
	$count = mysql_num_rows($count_query) +1;
    $article_unique = $user_id."_".$count;
 */
